  ...
  return (
    <PageTransition>
      ...
      <Flex w="100vw" h="100vh" overflow="hidden">
        ...
        >
          <Text fontSize="sm" fontWeight="bold" letterSpacing="2px">WEDDING ANNOUNCEMENT</Text>
          <Text fontSize="5xl" fontWeight="bold">TIFFANY & <br /> JARED</Text>
          <Text mt={4} fontStyle="italic" fontSize="xl" lineHeight="1.7" whiteSpace="pre-line">
            ...
            {!opened && (
              ...
              >
                ...
                >
                  ...
                  <Text fontSize="xl" opacity={0.8} fontStyle="italic">#TImetoshaRE</Text>
              ...
              >
                ...
                >
                  ...
                  <Box
                    ...
                    gap="0.5rem"
                    cursor="pointer"
                    onClick={() => openingRef.current.scrollIntoView({ behavior: "smooth" })}
                  >
                ...
                >
                  ...
                  <Text fontSize="lg" maxW="600px" lineHeight="1.8" fontStyle="italic" paddingLeft="20px" paddingRight="20px">
                ...
                >
                  ...
                  <Text fontSize="lg" maxW="700px" lineHeight="1.8" mb={10} fontStyle="italic">
                    The Daughter of
                    <br />
